        ...
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="space-y-3">
                    <li id="menu-1" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-green-600 hover:font-extrabold">
                        <MdDashboard className="mr-4 text-xl"/>
                        <span>Dashboard</span>
                    </li>
                    <li id="menu-2" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-green-600 hover:font-extrabold">
                        <FaShoppingCart className="mr-4 text-xl"/>
                        <span>Orders</span>
                    </li>
                    <li id="menu-3" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-green-600 hover:font-extrabold">
